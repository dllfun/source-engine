...
public:
	...
	virtual void InstallFactory(IClientEntityFactory* pFactory, const char* pClassName);
	virtual IClientNetworkable* Create(const char* pClassName, int entnum, int serialNum);
	virtual void Destroy(const char* pClassName, IClientNetworkable* pNetworkable);
	virtual const char* GetCannonicalName(const char* pClassName);
	virtual void ReportEntityNames();
	void ReportEntitySizes();

private:
	IClientEntityFactory* FindFactory(const char* pClassName);
public:
...
// Finds a new factory
//-----------------------------------------------------------------------------
IClientEntityFactory* CEntityFactoryDictionary::FindFactory(const char* pClassName)
{
...
//-----------------------------------------------------------------------------
void CEntityFactoryDictionary::InstallFactory(IClientEntityFactory* pFactory, const char* pClassName)
{
...
//-----------------------------------------------------------------------------
IClientNetworkable* CEntityFactoryDictionary::Create(const char* pClassName, int entnum, int serialNum)
{
	IClientEntityFactory* pFactory = FindFactory(pClassName);
	if (!pFactory)
	{
...
//-----------------------------------------------------------------------------
void CEntityFactoryDictionary::Destroy(const char* pClassName, IClientNetworkable* pNetworkable)
{
	IClientEntityFactory* pFactory = FindFactory(pClassName);
	if (!pFactory)
	{
