...
void BeamDrawHalo( const IVModel* spritemodel, float frame, int rendermode, const Vector& source,
...
void DrawBeamFollow( const IVModel* spritemodel, BeamTrail_t* pHead, int frame, int rendermode, Vector& delta,
...
class CEngineSprite *Draw_SetSpriteTexture( const IVModel *pSpriteModel, int frame, int rendermode );
