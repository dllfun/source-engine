...
#endif
	DEFINE_PRED_FIELD_TOL( m_flStamina.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, 0.1f ),
	DEFINE_PRED_FIELD( m_flCycle.m_Value, FIELD_FLOAT, FTYPEDESC_OVERRIDE | FTYPEDESC_PRIVATE | FTYPEDESC_NOERRORCHECK ),
	DEFINE_PRED_FIELD( m_iShotsFired.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_iDirection.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_bResumeZoom.m_Value, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_iLastZoom.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	...
	m_iv_angEyeAngles( "C_CSPlayer::m_iv_angEyeAngles" )
{
	...
	AddVar( &m_angEyeAngles.m_Value, &m_iv_angEyeAngles, LATCH_SIMULATION_VAR );
