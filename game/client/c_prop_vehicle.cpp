...
IMPLEMENT_CLIENTCLASS(C_PropVehicleDriveable, DT_PropVehicleDriveable, CPropVehicleDriveable)
...

{
	...
	AddVar( &m_vecGunCrosshair.m_Value, &m_iv_vecGunCrosshair, LATCH_SIMULATION_VAR );
}
