...
//-----------------------------------------------------------------------------
class CCrossfadableImagePanel : public vgui::EditablePanel
{
	DECLARE_CLASS_SIMPLE( CCrossfadableImagePanel, vgui::EditablePanel );
public:
	CCrossfadableImagePanel(vgui::Panel* pParent, const char *pName );
	...
	void SetImage(vgui::IImage *pImage, float flBlendTime = 0.0f );
	...
	virtual void InstallMouseHandler(vgui::Panel *pHandler );

private:
	virtual void OnSizeChanged( int nWide, int nTall );
	virtual void OnTick();

	inline vgui::ImagePanel *SrcImg()	{ return m_pImages[  m_iSrcImg ]; }
	inline vgui::ImagePanel *DstImg() { return m_pImages[ !m_iSrcImg ]; }
...
//-----------------------------------------------------------------------------
class CSlideshowPanel : public vgui::EditablePanel
{
	DECLARE_CLASS_SIMPLE( CSlideshowPanel, vgui::EditablePanel );
public:
	CSlideshowPanel(vgui::Panel *pParent, const char *pName );
	~CSlideshowPanel();
	...
	void AddImage(vgui::IImage *pImage );
