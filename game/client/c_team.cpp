...
IMPLEMENT_CLIENTCLASS(C_Team, DT_Team, CTeam)


BEGIN_PREDICTION_DATA( C_Team )
	DEFINE_PRED_ARRAY( m_szTeamname.m_Value, FIELD_CHARACTER, MAX_TEAM_NAME_LENGTH, FTYPEDESC_PRIVATE ),
	DEFINE_PRED_FIELD( m_iScore.m_Value, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	DEFINE_PRED_FIELD( m_iRoundsWon.m_Value, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
	...
	DEFINE_PRED_FIELD( m_iTeamNum.m_Value, FIELD_INTEGER, FTYPEDESC_PRIVATE ),
END_PREDICTION_DATA();
...
C_Team::C_Team()
{
	m_iScore = 0;
	m_iRoundsWon = 0;
	memset( m_szTeamname.m_Value, 0, sizeof(m_szTeamname.m_Value) );
