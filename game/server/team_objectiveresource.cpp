...
BEGIN_DATADESC( CBaseTeamObjectiveResource )
	...
	DEFINE_ARRAY( m_vCPPositions.m_Value, FIELD_VECTOR, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_bCPIsVisible.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_flLazyCapPerc.m_Value, FIELD_FLOAT, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_iTeamIcons.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS ),
	DEFINE_ARRAY( m_iTeamOverlays.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS ),
	DEFINE_ARRAY( m_iTeamReqCappers.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS ),
	DEFINE_ARRAY( m_flTeamCapTime.m_Value, FIELD_FLOAT, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS ),
	DEFINE_ARRAY( m_iPreviousPoints.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS*MAX_PREVIOUS_POINTS ),
	DEFINE_ARRAY( m_bTeamCanCap.m_Value, FIELD_BOOLEAN, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS ),
	DEFINE_ARRAY( m_iTeamBaseIcons.m_Value, FIELD_INTEGER, MAX_TEAMS ),
	DEFINE_ARRAY( m_iBaseControlPoints.m_Value, FIELD_INTEGER, MAX_TEAMS ),
	DEFINE_ARRAY( m_bInMiniRound.m_Value, FIELD_BOOLEAN, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_iWarnOnCap.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_iszWarnSound.m_Value, FIELD_STRING, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_iNumTeamMembers.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS*MAX_CONTROL_POINT_TEAMS ),
	DEFINE_ARRAY( m_iCappingTeam.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_iTeamInZone.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_bBlocked.m_Value, FIELD_BOOLEAN, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_iOwner.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_bCPCapRateScalesWithPlayers.m_Value, FIELD_BOOLEAN, MAX_CONTROL_POINTS ),
	...
	DEFINE_ARRAY( m_iCPGroup.m_Value, FIELD_INTEGER, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_bCPLocked.m_Value, FIELD_BOOLEAN, MAX_CONTROL_POINTS ),
	DEFINE_ARRAY( m_nNumNodeHillData.m_Value, FIELD_INTEGER, TEAM_TRAIN_MAX_TEAMS ),
	DEFINE_ARRAY( m_flNodeHillData.m_Value, FIELD_FLOAT, TEAM_TRAIN_HILLS_ARRAY_SIZE ),
	DEFINE_ARRAY( m_bTrackAlarm.m_Value, FIELD_BOOLEAN, TEAM_TRAIN_MAX_TEAMS ),
	DEFINE_ARRAY( m_flUnlockTimes.m_Value, FIELD_FLOAT,  MAX_CONTROL_POINTS  ),
	DEFINE_ARRAY( m_flCPTimerTimes.m_Value, FIELD_FLOAT,  MAX_CONTROL_POINTS  ),
