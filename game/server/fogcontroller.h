...
public:
	...
	BEGIN_SEND_TABLE(CFogController, DT_FogController, DT_BaseEntity)
		...
		SendPropColor32(SENDINFO_STRUCTELEM(m_fog.colorPrimary), 32, SPROP_UNSIGNED),
		SendPropColor32(SENDINFO_STRUCTELEM(m_fog.colorSecondary), 32, SPROP_UNSIGNED),
		...
		SendPropColor32(SENDINFO_STRUCTELEM(m_fog.colorPrimaryLerpTo), 32, SPROP_UNSIGNED),
		SendPropColor32(SENDINFO_STRUCTELEM(m_fog.colorSecondaryLerpTo), 32, SPROP_UNSIGNED),
