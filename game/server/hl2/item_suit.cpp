...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		...
		if ( m_spawnflags & SF_SUIT_SHORTLOGON )
			UTIL_EmitSoundSuit(pPlayer->NetworkProp()->GetEdict(), "!HEV_A0");		// short version of suit logon,
		else
			UTIL_EmitSoundSuit(pPlayer->NetworkProp()->GetEdict(), "!HEV_AAx");	// long version of suit logon
