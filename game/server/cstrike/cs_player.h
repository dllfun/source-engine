...
public:
	...
	DECLARE_PREDICTABLE();
	DECLARE_DATADESC();
	DECLARE_SEND_TABLE_ACCESS(DT_CSLocalPlayerExclusive);
	DECLARE_SEND_TABLE_ACCESS(DT_CSNonLocalPlayerExclusive);
	DECLARE_SEND_TABLE_ACCESS(DT_CSPlayer);

	CCSPlayer();
	~CCSPlayer();

	static CCSPlayer *CreatePlayer( const char *className, edict_t *edict );
