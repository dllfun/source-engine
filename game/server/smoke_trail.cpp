...
//Data table
//-----------------------------------------------------------------------------
IMPLEMENT_SERVERCLASS(SmokeTrail, DT_SmokeTrail, DT_BaseParticleEntity)
...
bool SmokeTrail::KeyValue( const char *szKeyName, const char *szValue ) 
{
	...
	{
		m_StopEmitTime = gpGlobals->GetCurTime() + atof( szValue );
		return true;
	}
...
{
	CBaseEntity *pEnt = engineServer->CreateEntityByName(SMOKETRAIL_ENTITYNAME);
	if(pEnt)
	{
...
//Data table
IMPLEMENT_SERVERCLASS(RocketTrail, DT_RocketTrail, DT_BaseParticleEntity)
...
{
	CBaseEntity *pEnt = engineServer->CreateEntityByName( "env_rockettrail" );
...
IMPLEMENT_SERVERCLASS( SporeTrail, DT_SporeTrail, DT_BaseParticleEntity)
...
{
	CBaseEntity *pEnt = engineServer->CreateEntityByName( SPORETRAIL_ENTITYNAME );
...
IMPLEMENT_SERVERCLASS( SporeExplosion, DT_SporeExplosion, DT_BaseParticleEntity)
...
{
	CBaseEntity *pEnt = engineServer->CreateEntityByName( SPOREEXPLOSION_ENTITYNAME );
...
IMPLEMENT_SERVERCLASS( CFireTrail, DT_FireTrail, DT_BaseParticleEntity)
...
{
	CBaseEntity *pEnt = engineServer->CreateEntityByName( "env_fire_trail" );
...
//Data table
//-----------------------------------------------------------------------------
IMPLEMENT_SERVERCLASS(DustTrail, DT_DustTrail, DT_BaseParticleEntity)
...
{
	CBaseEntity *pEnt = engineServer->CreateEntityByName(DUSTTRAIL_ENTITYNAME);
	if(pEnt)
	{
