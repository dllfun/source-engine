...
public:
	...
	virtual IServerEntityFactoryDictionary* GetEntityFactoryDictionary( void );
...
{
	return ::engineServer->CreateEntityByName( szClassName );
}
...
IServerEntityFactoryDictionary* CServerTools::GetEntityFactoryDictionary( void )
{
