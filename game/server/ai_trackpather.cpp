...
void CAI_TrackPather::OnRestore( void )
{
	...
	{
		m_pCurrentPathTarget = (CPathTrack *) gEntList.FindEntityByName( NULL, STRING( m_strCurrentPathName ) );
	}
	else
	{
		m_pCurrentPathTarget = NULL;
	...
	{
		m_pDestPathTarget = (CPathTrack *) gEntList.FindEntityByName( NULL, STRING( m_strDestPathName ) );
	}
	else
	{
		m_pDestPathTarget = NULL;
	...
	{
		m_pLastPathTarget = (CPathTrack *) gEntList.FindEntityByName( NULL, STRING( m_strLastPathName ) );
	}
	else
	{
		m_pLastPathTarget = NULL;
	...
	{
		m_pTargetNearestPath = (CPathTrack *) gEntList.FindEntityByName( NULL, STRING( m_strTargetNearestPathName ) );
	}
	else
	{
		m_pTargetNearestPath = NULL;
...
void CAI_TrackPather::SetTrack( string_t strTrackName )
{
	...
	CBaseEntity *pGoalEnt = gEntList.FindEntityByName( NULL, STRING( strTrackName ) );
	if ( pGoalEnt == NULL )
	{
