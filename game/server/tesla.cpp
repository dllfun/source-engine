...
IMPLEMENT_SERVERCLASS( CTesla, DT_Tesla, DT_BaseEntity)
...
CBaseEntity* CTesla::GetSourceEntity()
{
	...
	{
		CBaseEntity *pRet = gEntList.FindEntityByName( NULL, STRING( m_SourceEntityName ) );
		if ( pRet )
			return pRet;
	}
...
void CTesla::DoSpark()
{
	...
	EntityMessageBegin( this );
		...
		WRITE_SHORT( pEnt->NetworkProp()->entindex());
