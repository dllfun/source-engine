...
//	DEFINE_FIELD( m_vecForce, FIELD_VECTOR ),
	...
	DEFINE_ARRAY( m_flPoseParameter.m_Value, FIELD_FLOAT, CBaseAnimating::NUM_POSEPAREMETERS ),
	DEFINE_ARRAY( m_flEncodedController.m_Value,	FIELD_FLOAT, CBaseAnimating::NUM_BONECTRLS ),
