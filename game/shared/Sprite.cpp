...
BEGIN_PREDICTION_DATA( CSprite )
	...
	// Networked
	DEFINE_PRED_FIELD( m_hAttachedToEntity.m_Value, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_nAttachment.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_flScaleTime.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_flSpriteScale.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_flSpriteFramerate.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
...
#endif
	DEFINE_PRED_FIELD( m_flBrightnessTime.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_nBrightness.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
