...
#define TICK_INTERVAL			(gpGlobals->GetIntervalPerTick())
...
#define VEC_VIEW_SCALED( player )				( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vView * player->GetModelScale()) )
#define VEC_HULL_MIN_SCALED( player )			( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vHullMin * player->GetModelScale()) )
#define VEC_HULL_MAX_SCALED( player )			( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vHullMax * player->GetModelScale()) )

#define VEC_DUCK_HULL_MIN_SCALED( player )		( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vDuckHullMin * player->GetModelScale()) )
#define VEC_DUCK_HULL_MAX_SCALED( player )		( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vDuckHullMax * player->GetModelScale()) )
#define VEC_DUCK_VIEW_SCALED( player )			( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vDuckView * player->GetModelScale()) )

#define VEC_OBS_HULL_MIN_SCALED( player )		( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vObsHullMin * player->GetModelScale()) )
#define VEC_OBS_HULL_MAX_SCALED( player )		( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vObsHullMax * player->GetModelScale()) )

#define VEC_DEAD_VIEWHEIGHT_SCALED( player )	( g_pGameRules==NULL?Vector(0,0,0):(g_pGameRules->GetViewVectors()->m_vDeadViewHeight * player->GetModelScale()) )
