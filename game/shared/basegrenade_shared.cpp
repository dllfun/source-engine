...
BEGIN_PREDICTION_DATA( CBaseGrenade  )
	...
	DEFINE_PRED_FIELD( m_hThrower.m_Value, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_bIsLive.m_Value, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_DmgRadius.m_Value, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
//	DEFINE_PRED_FIELD_TOL( m_flDetonateTime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, TD_MSECTOLERANCE ),
	DEFINE_PRED_FIELD( m_flDamage.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),

	DEFINE_PRED_FIELD_TOL( m_vecVelocity.m_Value, FIELD_VECTOR, FTYPEDESC_INSENDTABLE, 0.5f ),
	DEFINE_PRED_FIELD_TOL( m_flNextAttack.m_Value, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, TD_MSECTOLERANCE ),
...
void CBaseGrenade::Explode( trace_t *pTrace, int bitsDamageType )
{
	...
	if ( pTrace->fraction != 1.0 )
	{
		...
		g_pTESystem->Explosion( filter, -1.0, // don't apply cl_interp delay
			&vecAbsOrigin,
