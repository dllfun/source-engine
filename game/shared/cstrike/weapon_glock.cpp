...
public:
	...
	DECLARE_PREDICTABLE();
#ifndef CLIENT_DLL
	DECLARE_SEND_TABLE_ACCESS(DT_WeaponGlock);
#endif
...
#ifndef CLIENT_DLL
	BEGIN_INIT_SEND_TABLE(CWeaponGlock)
...
#ifdef CLIENT_DLL
	BEGIN_INIT_RECV_TABLE(CWeaponGlock)
	BEGIN_NETWORK_TABLE(CWeaponGlock, DT_WeaponGlock, DT_WeaponCSBase)
...
BEGIN_PREDICTION_DATA( CWeaponGlock )
	...
	DEFINE_PRED_FIELD( m_iBurstShotsRemaining.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
