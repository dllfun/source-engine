...
public:
	...
	DECLARE_PREDICTABLE();
#ifndef CLIENT_DLL
	DECLARE_SEND_TABLE_ACCESS(DT_WeaponXM1014);
#endif
...
#ifndef CLIENT_DLL
	BEGIN_INIT_SEND_TABLE(CWeaponXM1014)
...
#ifdef CLIENT_DLL
	BEGIN_INIT_RECV_TABLE(CWeaponXM1014)
	BEGIN_NETWORK_TABLE(CWeaponXM1014, DT_WeaponXM1014, DT_WeaponCSBase)
...
BEGIN_PREDICTION_DATA( CWeaponXM1014 )
	DEFINE_PRED_FIELD( m_reloadState.m_Value, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
END_PREDICTION_DATA()
#endif
