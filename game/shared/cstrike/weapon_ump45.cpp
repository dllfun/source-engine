...
public:
#ifndef CLIENT_DLL
	BEGIN_INIT_SEND_TABLE(CWeaponUMP45)
	BEGIN_NETWORK_TABLE(CWeaponUMP45, DT_WeaponUMP45, DT_WeaponCSBaseGun)

	END_NETWORK_TABLE(DT_WeaponUMP45)
	END_INIT_SEND_TABLE()
#endif

#ifdef CLIENT_DLL
	BEGIN_INIT_RECV_TABLE(CWeaponUMP45)
	BEGIN_NETWORK_TABLE(CWeaponUMP45, DT_WeaponUMP45, DT_WeaponCSBaseGun)
